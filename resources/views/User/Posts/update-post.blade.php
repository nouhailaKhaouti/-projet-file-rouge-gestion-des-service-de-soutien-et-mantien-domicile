<button type="button" post_id="{{$post->id}}"  data-bs-toggle="modal" data-bs-target="#PostUpdate" class="btn rounded-2 bg_green fw-bold text-white" id="update{{$post->id}}">edit <a><i class="fa-solid fa-plus"></i></a></button>
